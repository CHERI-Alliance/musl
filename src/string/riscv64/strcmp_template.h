...
/*
 * Calculate the number of bytes that can be accessed without crossing
 * capability boundaries of ca0 or ca1. If given, the user provided
 * limit is taken into account, too. If LIMITREG is defined "target"
 * should initially contain the number of remaining bytes according
 * to the user limit.
 */
