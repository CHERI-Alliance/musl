...
override TMP = tmp
override SOURCES = \
	arch/aarch64/morello.objects \
	test/libc-test-enabled-tests.txt
override SOURCES := $(notdir $(SOURCES))

override OBJECTS = $(shell cat arch/aarch64/morello.objects)
override CHECKS = $(SOURCES:%=$(TMP)/%)
override CHECKS += $(OBJECTS:%.o=check/%.o)

check: $(CHECKS)
	@cmp arch/aarch64/morello.objects $(TMP)/morello.objects
...
$(TMP)/morello.objects: arch/aarch64/morello.objects | $(TMP)
